...
public class bullyLeaderElection {
    ...
    public bullyLeaderElection(){
        try {
            servers.put(1,InetAddress.getByName("129.21.22.196")); //glados
            servers.put(2,InetAddress.getByName("129.21.30.37")); //queeg
            servers.put(3,InetAddress.getByName("129.21.34.80")); // comet
            servers.put(4,InetAddress.getByName("129.21.37.49")); // rhea
            servers.put(5,InetAddress.getByName("129.21.37.32")); // hendrix
//            servers.put(6,InetAddress.getByName("129.21.37.55")); // gorgon
//            servers.put(7,InetAddress.getByName("129.21.37.30")); // kinks
